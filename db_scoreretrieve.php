...
<html>
<head>
  <title>VIEW SCORE IN THE DATABASE:</title>
...
<div class="topnav">
  ...
  <div class ="task">
      ...
      <a href="db_scoreretrieve.php" style="float:center">View Scores</a>
        ...
        <div class ="welcome">
        <h3><font size="7" color="white">Select Game Results to View:</font></h3>
        </div>
        <div id ="register">
 <form action="db_scoreselect.php" method="POST">
   ...
   <tr>
   <td><input type="checkbox" name="game1score" value="game1score"><font size="5" color="white">Game - 1</font><br></td>
   </tr>
  
   <tr>
    <td><input type="checkbox" name="game2score" value="game2score"><font size="5" color="white">Game - 2</font><br></td>
   <tr>
    <td><input type="checkbox" name="game3score" value="game3score"><font size="5" color="white">Game - 3</font><br></td>
   </tr>
   <tr>
    <td><input type="checkbox" name="game4score" value="game4score"><font size="5" color="white">Game - 4</font><br></td>
   </tr> 
   <tr>
    <td><input type="checkbox" name="game5score" value="game5score"><font size="5" color="white">Game - 5</font><br></td>
   </tr> 
   <tr align = "center">
    <td> <a href="db_scoreselect.php"><button class="button button-block"/>SELECT GAME to VIEW</button></a></td>
   </tr>
  </table> 
 </form>
         </div>
