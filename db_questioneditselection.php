...
// Checks for games and names for display
            if ( $result1->num_rows == 0 ) {
                       ...
                       $gamename1 = "There is no Data for Game 1!";
    }
                ...
                if ( $result2->num_rows == 0 ) {
                       ...
                       $gamename2 = "There is no Data for Game 2!";
    }
                ...
                if ( $result3->num_rows == 0 ) {
                       ...
                       $gamename3 = "There is no Data for Game 3!";
    }
                ...
                if ( $result4->num_rows == 0 ) {
                       ...
                       $gamename4 = "There is no Data for Game 4!";
    }
                ...
                if ( $result5->num_rows == 0 ) {
                       ...
                       $gamename5 = "There is no Data for Game 5!";
    }
...
<html>
<head>
  <title>EDIT A GAME IN THE DATABASE:</title>
  <link rel="stylesheet" href="modifyselectstyle.css">
</head>
<body>
     <header>
...
<div class="topnav">
  ...
  <div class ="task">
      ...
      <a href="db_scoreretrieve.php" style="float:center">View Scores</a>
        ...
        <div id ="register">
 <form action="db_questionedit.php" method="POST">
   ...
   <tr>
   <td><input type="checkbox" name="game1edit" value="game1edit"><font size="5" color="white">Game - 1</font><br></td>
   </tr>
  
   <tr>
    <td><input type="checkbox" name="game2edit" value="game2edit"><font size="5" color="white">Game - 2</font><br></td>
   <tr>
    <td><input type="checkbox" name="game3edit" value="game3edit"><font size="5" color="white">Game - 3</font><br></td>
   </tr>
   <tr>
    <td><input type="checkbox" name="game4edit" value="game4edit"><font size="5" color="white">Game - 4</font><br></td>
   </tr> 
   <tr>
    <td><input type="checkbox" name="game5edit" value="game5edit"><font size="5" color="white">Game - 5</font><br></td>
   </tr> 
   <tr align = "center">
    <td> <a href="db_questionedit.php"><button class="button button-block"/>EDIT</button></a></td>
   </tr>
  </table> 
 </form>
</div>
